...
class WebFeed {
  static WebFeed fromXmlString(String xmlString) {
    ...
    final rssVersion = detectRssVersion(xmlDoc);
    switch (rssVersion) {
      case RssVersion.rss1:
        final rss1Feed = Rss1Feed.parse(xmlDoc);
        return WebFeed.fromRss1(rss1Feed);
      case RssVersion.rss2:
        final rss2Feed = RssFeed.parse(xmlDoc);
        return WebFeed.fromRss2(rss2Feed);
      case RssVersion.atom:
        final atomFeed = AtomFeed.parse(xmlDoc);
  ...
  static RssVersion detectRssVersion(xml.XmlDocument xmlDoc) {
