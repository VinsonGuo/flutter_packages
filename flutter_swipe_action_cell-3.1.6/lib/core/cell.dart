...
class SwipeActionCellState extends State<SwipeActionCell>
  ...
  void _onHorizontalDragEnd(DragEndDetails details) async {
    ...
    if (lastItemOut && canFullSwipe) {
      ...
      if (details.velocity.pixelsPerSecond.dx < -widget.velocityThreshold) {
        ...
        return;
      } else if (details.velocity.pixelsPerSecond.dx > widget.velocityThreshold) {
